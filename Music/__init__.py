...
async def load_sudoers():
    ...
    print("[INFO]: PENGGUNA SUDO YANG DIMUAT")
    try:
        repo = Repo()
...
ASSUSERNAME = ""
ASSMENTION = ""
print("[INFO]: MENGINISIALISASI KLIEN BOT")
app = Client(
    "MusicBot",
    API_ID,
    API_HASH,
...
print("[INFO]: MEMULAI KLIEN BOT")
app.start()
print("[INFO]: MEMULAI KLIEN ASISTEN")
client.start()
print("[INFO]: INFO BOT MUAT/PROFIL ASISTEN")
all_info(app, client)
print("[INFO]: INFO PROFIL BOT/ASISTEN YANG DIMUAT")
